...
_USB_BACKEND = _libusb1_backend.get_backend(find_library=lambda x: r'D:\DL\Programacion Tytera MD380\tools\libusb-1.0.dll')
import zlib
import os.path
...
def get_dfu_devices(*args, **kwargs):
    ...
    return list(usb.core.find(*args, find_all=True, backend=_USB_BACKEND, custom_match=FilterDFU(), **kwargs))
